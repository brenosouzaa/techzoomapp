  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CommentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CommentsRecord> coementariosCommentsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final coementariosCommentsRecord =
            coementariosCommentsRecordList.isNotEmpty
                ? coementariosCommentsRecordList.first
                : null;
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              context.pushNamed('comentarCopy');
                                            },
                                            child: Icon(
                                              Icons.comment,
                                              color:
