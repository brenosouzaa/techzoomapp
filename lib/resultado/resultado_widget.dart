...
class ResultadoWidget extends StatefulWidget {
  const ResultadoWidget({
    Key? key,
    this.resultado,
    this.commenstparaments,
  }) : super(key: key);

  final DocumentReference? resultado;
  final ProdutosRecord? commenstparaments;
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '4yivtfyh' /* 50 pessoas deram nota pra  ess... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    child: Image.network(
                                                                                      listViewCommentsRecord.photoUrl,
                                                                                      fit: BoxFit.cover,
                                                                                    ),
                                                                                  ),
                                                                                ),
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: StreamBuilder<UsersRecord>(
                                                                                stream: UsersRecord.getDocument(listViewCommentsRecord.commentsUser!),
                                                                                builder: (context, snapshot) {
                                                                                  // Customize what your widget looks like when it's loading.
                                                                                  if (!snapshot.hasData) {
                                                                                    return Center(
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        final postLikedByUpdate = listViewCommentsRecord.postLikedBy.contains(postLikedByElement)
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              context.pushNamed('coementarios');
                                                                            },
                                                                            child:
                                                                                Icon(
                                                                              Icons.comment,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            listViewCommentsRecord.postLikedBy.length.toString(),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  fontFamily: 'Poppins',
                                                                                  color: FlutterFlowTheme.of(context).primaryText,
                                                                                  fontSize: 13.0,
