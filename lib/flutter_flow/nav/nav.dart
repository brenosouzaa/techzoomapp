...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child: appStateNotifier.loggedIn ? HomePageWidget() : LoginWidget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
          ...
          routes: [
            ...
            FFRoute(
              ...
              asyncParams: {
                'commenstparaments':
                    getDoc(['produtos'], ProdutosRecord.fromSnapshot),
              },
              builder: (context, params) => ResultadoWidget(
                resultado: params.getParam('resultado',
                    ParamType.DocumentReference, false, ['produtos']),
                commenstparaments:
                    params.getParam('commenstparaments', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'categoriaCopy',
            ...
            FFRoute(
              ...
              builder: (context, params) => ComentarWidget(
                commentsparaments: params.getParam('commentsparaments',
                    ParamType.DocumentReference, false, ['produtos']),
              ),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'comentarCopy',
              requireAuth: true,
              builder: (context, params) => ComentarCopyWidget(),
            )
