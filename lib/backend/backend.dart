...
import 'schema/curtidas_record.dart';
...
export 'schema/curtidas_record.dart';
export 'schema/users_record.dart';
export 'schema/produtos_record.dart';
export 'schema/comments_record.dart';

/// Functions to query CurtidasRecords (as a Stream and as a Future).
Future<int> queryCurtidasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CurtidasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CurtidasRecord>> queryCurtidasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      CurtidasRecord.collection,
      CurtidasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CurtidasRecord>> queryCurtidasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<CurtidasRecord>> queryCurtidasRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, CurtidasRecord> controller,
    ...
    queryCollectionPage(
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<CurtidasRecord> data) {
          data.forEach((item) {
